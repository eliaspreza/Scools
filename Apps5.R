...
# |                                  (Versión 4.1 - Corregida)                |
# -----------------------------------------------------------------------------

# --- 1. Carga de Librerías ---
# install.packages(c("shiny", "leaflet", "dplyr", "googlesheets4", "htmltools", "DT", "tidyr"))
...
tryCatch({
  mapa_data_raw <- read_sheet(google_sheet_url)
}, error = function(e) {
  stop("Error al leer la hoja de Google Sheets. Verifica la URL y tus permisos de acceso. Error original: ", e$message)
})
...
ui <- fluidPage(
  ...
  fluidRow(
    column(width = 2,
           ...
           #a(img(src = "https://media.licdn.com/dms/image/v2/C560BAQE93z4FbxjLCg/company-logo_200_200/company-logo_200_200/0/1630617827310/eurolatina_logo?e=1755129600&v=beta&t=EDbY6wBnBUVsxh1Ch_A252TjB29yW9GpEjpUCn-d-rE", class = "custom-logo",style="margin-top: 0px; padding-left:36px;padding-bottom:5px", height = 60)),
